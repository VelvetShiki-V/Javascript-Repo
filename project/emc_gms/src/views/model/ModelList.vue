...
import { DataEvent } from '@/type/dataEvent'

// 响应式数据
const dataLoading = ref<boolean>(true)
const modelStore = useModelStore()
const initialize = async () => {
  await modelStore.getModelListAsync()
...
const handleQuery = () => {}
const handleEdit = (eventType: DataEvent, row: ModelInstance) => {
  console.log(eventType, row)
}
const handleSubmit = (eventType: DataEvent, row: ModelInstance) => {
  console.log(eventType, row)
}
